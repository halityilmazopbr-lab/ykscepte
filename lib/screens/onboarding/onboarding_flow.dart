      ...
      child: Column(
        children: [
          ...
          Expanded(
            child: ListView(
              children: [
                _buildTutorialCard('📚', 'Program Sihirbazı', 'Haftalık çalışma programı otomatik oluştur'),
                _buildTutorialCard('📊', 'Deneme Raporları', 'Net artışını ve başarı grafiklerini incele'),
                _buildTutorialCard('🎯', 'Hedef & Ödül', 'Çalışma hedefi belirle, dijital ödül kazan'),
                _buildTutorialCard('🤫', 'Sessiz Kütüphane', 'Gerçek zamanlı çalışma odasI - Çıkınca avatar uyur'),
                _buildTutorialCard('🧬', 'Sınav İkizi', 'Aynı seviyeden rakip bulup günlük düello'),
                _buildTutorialCard('🕵️', 'NET Dedektifi', 'Optik okuyucu ile deneme çözümlemesi'),
                _buildTutorialCard('🏆', 'NET Ligi', 'Haftalık bireysel + okul ligleri'),
                _buildTutorialCard('🔮', 'Kahin', 'Hedef sıralamana kaç net ile ulaşırsın?'),
                _buildTutorialCard('⚡', 'Focus Modu', '3 farklı mod: Sensor, Optical, Chrono'),
                _buildTutorialCard('📱', 'Canlı Trivia', 'Admin kontrollü canlı yarışma'),
                _buildTutorialCard('🧪', 'Psikolojik Testler', 'Burdon Dikkat Testi + Envanterler'),
                _buildTutorialCard('📝', 'Hata Defteri', 'Çözemediğin soruları fotoğrafla kaydet'),
                _buildTutorialCard('🗂️', 'Flashcards', 'Dijital kart sistemi ile tekrar'),
                _buildTutorialCard('🧠', 'Psikolojik Destek', 'VIP danışmanlık paketleri'),
              ],
            ),
          ),
          const SizedBox(height: 16),
