          ...
          Expanded(
            child: ListView(
              children: [
                ...
                _buildTutorialCard('📚', 'Programım', 'Haftalık çalışma programın'),
                _buildTutorialCard('✅', 'Konu Takip', 'Hangi konuları bitirdin?'),
                _buildTutorialCard('📝', 'Soru Takip', 'Çözdüğün soruları takip et'),
                _buildTutorialCard('📖', 'Notlarım', 'Okul sınav notların'),
                _buildTutorialCard('📋', 'Ödevlerim', 'Kurum ödevlerin'),
                _buildTutorialCard('➕', 'Deneme Ekle', 'Yeni deneme gir'),
                _buildTutorialCard('📊', 'Denemelerim', 'Tüm denemeler'),
                _buildTutorialCard('📈', 'Grafik', 'Net artışı grafiği'),
                _buildTutorialCard('🏅', 'Rapor & Sıralama', 'Başarı raporu'),
                _buildTutorialCard('📆', 'Günlük Takip', 'Günlük çalışma kaydı'),
                const SizedBox(height: 20),
                const Padding(
                  padding: EdgeInsets.only(bottom: 12),
                  child: Text('🛠️ ARAÇLAR', style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: Color(0xFF8B5CF6))),
                ),
                _buildTutorialCard('📕', 'Hata Defteri', 'Çözemediğin soruları kaydet'),
                _buildTutorialCard('🎧', 'Odak Modu', 'Konsantrasyon modları'),
                _buildTutorialCard('🎴', 'Flashcards', 'Dijital kart sistemi'),
                _buildTutorialCard('🧠', 'Soru Üreteci', 'AI ile soru oluştur'),
                _buildTutorialCard('✨', 'Program Sihirbazı', 'Otomatik program oluştur'),
                _buildTutorialCard('💬', 'AI Asistan', 'Yapay zeka koçun'),
                _buildTutorialCard('📸', 'Soru Çöz', 'Fotoğrafla soru çöz'),
                _buildTutorialCard('⏱️', 'Kronometre', 'Çalışma süren'),
                _buildTutorialCard('🧪', 'Rehberlik', 'Psikolojik testler'),
                _buildTutorialCard('🏆', 'Rozetlerim', 'Kazanılan rozetler'),
                const SizedBox(height: 20),
                const Padding(
                  padding: EdgeInsets.only(bottom: 12),
                  child: Text('🎮 ÖZEL SİSTEMLER', style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: Color(0xFF10B981))),
                ),
                _buildTutorialCard('🤫', 'Sessiz Kütüphane', 'Gerçek zamanlı çalışma odası'),
                _buildTutorialCard('🎯', 'Hedeflerim', 'Çalışma hedefleri'),
                _buildTutorialCard('🎁', 'Ödül Mağazası', 'Dijital ödüller'),
                _buildTutorialCard('💆', 'Psikolojik Destek', 'Danışmanlık paketleri'),
                _buildTutorialCard('👨‍⚕️', 'Paketim', 'Aktif danışmanlık paketim'),
              ],
            ),
          ),
          const SizedBox(height: 16),
